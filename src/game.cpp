...
const char* Game::getPlayerInfo(int16_t playerPos, int64_t chipsDiff) const noexcept {
...
OutEnum Game::setBlinds() noexcept {
    ...
    const char* playerInfo = this->getPlayerInfo(-1, -this->data.roundData.smallBlind);
