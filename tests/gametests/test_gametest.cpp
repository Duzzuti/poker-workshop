...
TEST(ClassName, TestName) {
    const TestConfig testConfig{.numPlayers = 3,
                                .smallBlind = 10,
                                .playerChips = {900, 500, 120},
                                .playerHands = {{Card{3, 1}, Card{14, 2}}, {Card{7, 0}, Card{11, 0}}, {Card{2, 3}, Card{2, 2}}},
                                .drawnCards = {},
                                .communityCards = {Card{14, 3}, Card{3, 3}, Card{3, 0}, Card{5, 2}, Card{6, 2}},
