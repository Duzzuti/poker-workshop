...
class CheckPlayer : public Player {
   public:
    ...
    CheckPlayer(const char* name, const u_int8_t index) : Player(name, index){};
    ...
    CheckPlayer(const u_int8_t playerNum, const bool appendNum, const u_int8_t index) noexcept : Player(createPlayerName("CheckPlayer", playerNum, appendNum), index){};
